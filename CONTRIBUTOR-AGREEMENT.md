# Draftila Contributor Agreement

By submitting a pull request to Draftila, you agree to the following terms for each contribution you submit.

## Definitions

- "You" means the individual or legal entity submitting a contribution.
- "Contribution" means any code, documentation, or other material intentionally submitted to this repository.
- "Maintainer" means the project owner and legal successors maintaining the project.
...
- The contribution is your original work, or you have the necessary rights to submit it under these terms.
- If you submit on behalf of an organization, you are authorized to bind that organization.
...
Except where required by law, contributions are provided "as is", without warranties or conditions of any kind.
